...
template <typename DerivedT>
class ConvertArmSMEToLLVMBase : public ::mlir::OperationPass<> {
public:
  using Base = ConvertArmSMEToLLVMBase;

  ConvertArmSMEToLLVMBase() : ::mlir::OperationPass<>(::mlir::TypeID::get<DerivedT>()) {}
  ConvertArmSMEToLLVMBase(const ConvertArmSMEToLLVMBase &other) : ::mlir::OperationPass<>(other) {}
...
public:
  ...
  ConvertGPUToSPIRVBase(const ConvertGPUToSPIRVOptions &options) : ConvertGPUToSPIRVBase() {
    ...
    useCoopMatrixNV = options.useCoopMatrixNV;
  }
protected:
  ...
  ::mlir::Pass::Option<bool> useCoopMatrixNV{*this, "use-coop-matrix-nv", ::llvm::cl::desc("Use the NV cooperative matrix extension insted of the KHR extension to lower GPU WMMA ops"), ::llvm::cl::init(false)};
private:
};
} // namespace impl
