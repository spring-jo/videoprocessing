...
enum DebugOptions_CommandBufferCmdType : int {
  ...
  DebugOptions_CommandBufferCmdType_NCCL = 4,
  DebugOptions_CommandBufferCmdType_WHILE = 5,
...
constexpr DebugOptions_CommandBufferCmdType DebugOptions_CommandBufferCmdType_CommandBufferCmdType_MAX = DebugOptions_CommandBufferCmdType_WHILE;
...
class DebugOptions final :
 ...
 public:
  ...
  static constexpr CommandBufferCmdType NCCL =
    DebugOptions_CommandBufferCmdType_NCCL;
  static constexpr CommandBufferCmdType WHILE =
    DebugOptions_CommandBufferCmdType_WHILE;
