...
class HloInstructionProto final :
 ...
 public:
  ...
  enum : int {
    ...
    kWaitOnOperationQueuesFieldNumber = 84,
    kNameFieldNumber = 1,
    ...
    kOperationQueueIdFieldNumber = 83,
...
// int64 operation_queue_id = 83;
inline void HloInstructionProto::clear_operation_queue_id() {
  _impl_.operation_queue_id_ = int64_t{0};
}
inline int64_t HloInstructionProto::_internal_operation_queue_id() const {
  return _impl_.operation_queue_id_;
}
inline int64_t HloInstructionProto::operation_queue_id() const {
  // @@protoc_insertion_point(field_get:xla.HloInstructionProto.operation_queue_id)
  return _internal_operation_queue_id();
}
inline void HloInstructionProto::_internal_set_operation_queue_id(int64_t value) {
  
  _impl_.operation_queue_id_ = value;
}
inline void HloInstructionProto::set_operation_queue_id(int64_t value) {
  _internal_set_operation_queue_id(value);
  // @@protoc_insertion_point(field_set:xla.HloInstructionProto.operation_queue_id)
}

// repeated int64 wait_on_operation_queues = 84;
inline int HloInstructionProto::_internal_wait_on_operation_queues_size() const {
  return _impl_.wait_on_operation_queues_.size();
}
inline int HloInstructionProto::wait_on_operation_queues_size() const {
  return _internal_wait_on_operation_queues_size();
}
inline void HloInstructionProto::clear_wait_on_operation_queues() {
  _impl_.wait_on_operation_queues_.Clear();
}
inline int64_t HloInstructionProto::_internal_wait_on_operation_queues(int index) const {
  return _impl_.wait_on_operation_queues_.Get(index);
}
inline int64_t HloInstructionProto::wait_on_operation_queues(int index) const {
  // @@protoc_insertion_point(field_get:xla.HloInstructionProto.wait_on_operation_queues)
  return _internal_wait_on_operation_queues(index);
}
inline void HloInstructionProto::set_wait_on_operation_queues(int index, int64_t value) {
  _impl_.wait_on_operation_queues_.Set(index, value);
  // @@protoc_insertion_point(field_set:xla.HloInstructionProto.wait_on_operation_queues)
}
inline void HloInstructionProto::_internal_add_wait_on_operation_queues(int64_t value) {
  _impl_.wait_on_operation_queues_.Add(value);
}
inline void HloInstructionProto::add_wait_on_operation_queues(int64_t value) {
  _internal_add_wait_on_operation_queues(value);
  // @@protoc_insertion_point(field_add:xla.HloInstructionProto.wait_on_operation_queues)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< int64_t >&
HloInstructionProto::_internal_wait_on_operation_queues() const {
  return _impl_.wait_on_operation_queues_;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< int64_t >&
HloInstructionProto::wait_on_operation_queues() const {
  // @@protoc_insertion_point(field_list:xla.HloInstructionProto.wait_on_operation_queues)
  return _internal_wait_on_operation_queues();
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField< int64_t >*
HloInstructionProto::_internal_mutable_wait_on_operation_queues() {
  return &_impl_.wait_on_operation_queues_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField< int64_t >*
HloInstructionProto::mutable_wait_on_operation_queues() {
  // @@protoc_insertion_point(field_mutable_list:xla.HloInstructionProto.wait_on_operation_queues)
